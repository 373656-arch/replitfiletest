...
function renderHeader() {
    global $pageTitle, $pageDescription, $currentUser, $isUserAdmin;
    ?>
    <!DOCTYPE html>
            ...
            <nav>
                    ...
                    <?php if ($isUserAdmin): ?>
                        <a href="/admin.php" title="Admin">
                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 16 16">
                                ...
                                <path d="M8 5a3 3 0 1 1 0 6 3 3 0 0 1 0-6"/>
                            </svg>
                        </a>
                    <?php endif; ?>
                ...
                <?php else: ?>
                    <a href="/index.php" title="Home">
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 16 16">
                            <path d="M8.354 1.146a.5.5 0 0 0-.708 0l-6 6A.5.5 0 0 0 1.5 7.5v7a.5.5 0 0 0 .5.5h4.5v-5h3v5H14a.5.5 0 0 0 .5-.5v-7a.5.5 0 0 0-.146-.354L13 5.793V2.5a.5.5 0 0 0-.5-.5h-1a.5.5 0 0 0-.5.5v1.293z"/>
                        </svg>
                    </a>
                    <a href="/community.php" title="Community">
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 16 16">
